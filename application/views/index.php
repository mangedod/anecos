...
<head>
  ...
  <title>Anecos - a codding landing page template for codrops</title>
...
<body>
  <nav>
    ...
    <ul class="menu">
      ...
      <li class="menu__item"><a href="doc.html" class="link link--dark"><i class="fa fa-book"></i> Documentation</a>
      </li>
    ...
    <div class="installation">
      ...
      <div class="tab__container">
        ...
        <pre class="nohighlight code">
            <code class="tab__pane active mac">$  brew install Anecos</code>
            <code class="tab__pane linux">$  apt-get install Anecos</code>
            <code class="tab__pane win">$  gem install Anecos</code>
          </pre>
      </div>
    </div>
    <div class="feature">
      ...
      <div class="feature__item">
        ...
        <p>For better readability, Anecos has a clean, beautiful color scheme allow you to scan files fast.</p>
      </div>
      <div class="feature__item">
        <h3 class="section__title">Keybindings</h3>
        <p>You can expect common keybindings for Anecos. Customize <span class="code code--inline">bindings.json</span>
